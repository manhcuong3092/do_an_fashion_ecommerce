...
const MapMaker = () => (
  <div>
    <i class="fa-solid fa-location-dot" style={{ color: 'red', fontSize: '20px' }}></i>
  </div>
);
        ...
        <Row>
          <Col>
            <div className="googleMap-info">
              <div id="googleMap" style={{ height: '50vh', width: '100%' }}>
                <GoogleMapReact
                  bootstrapURLKeys={{ key: 'AIzaSyDiixWOmy0M45TbhVY5XpecnueXEc15E1U' }}
                  defaultCenter={map.center}
                  defaultZoom={map.zoom}
                >
                  <MapMaker lat={21.108785} lng={105.692478} text="My Marker" />
                </GoogleMapReact>
              </div>
              <div className="map-info">
                <p>
                  <strong>Amando</strong>
                </p>
              </div>
            </div>
          </Col>
